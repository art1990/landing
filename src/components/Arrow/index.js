...
const Arrow = ({ isHover, isClick, isBackgroundTransparent }) => (
  <svg
    width="27"
    height="27"
    viewBox="0 0 27 27"
  ...
  >
    <circle
      ...
      r="13.5"
      fill={
        isHover ? "#F61067" : isBackgroundTransparent ? "transparent" : "white"
      }
    />
    <circle
      cx="13.5"
      ...
      r="13"
      stroke={
        isClick || (isBackgroundTransparent && !isHover) ? "white" : "#F61067"
      }
      strokeOpacity={isClick ? 1 : 0.5}
    />
    <path
      ...
      fill={isHover || isBackgroundTransparent ? "white" : "#F61067"}
    />
  </svg>
);
